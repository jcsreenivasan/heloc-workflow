                ...
                {formStep === 'email' && (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      onClick={() => { setEmailError(''); setFormStep('details'); }}
                      className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 bg-white border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all mb-3"
                    >
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-xs font-medium" style={{ color: '#757575' }}>or</span>
                      <div className="flex-1 h-px bg-gray-200" />
                    </div>
